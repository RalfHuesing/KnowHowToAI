...
internal static class SqlSchemaContractAssertions
{
    ...
    private static async Task AssertConstraintsAsync(SqlConnection connection)
    {
        const string sql = """
            ...
            """;
        var actual = await ReadRowsAsync(connection, sql);
        Assert.Equal(ExpectedChecks, actual);
    }
    ...
    private static async Task AssertForeignKeysAsync(SqlConnection connection)
    {
        const string sql = """
            ...
            """;
        var actual = await ReadRowsAsync(connection, sql);
        Assert.Equal(ExpectedForeignKeys, actual);
    }
    ...
    [
        "KnowHowToAI_ContentDependency|SnapshotId|bigint|8|19|0|False|", "KnowHowToAI_ContentDependency|TargetNodeId|uniqueidentifier|16|0|0|False|", "KnowHowToAI_ContentDependency|TargetRoleId|nvarchar|100|0|0|False|", "KnowHowToAI_ContentDependency|SourceNodeId|uniqueidentifier|16|0|0|False|", "KnowHowToAI_ContentDependency|SourceRoleId|nvarchar|100|0|0|False|", "KnowHowToAI_ContentDependency|SourceContentRevisionId|uniqueidentifier|16|0|0|False|",
        ...
        "KnowHowToAI_Role|SnapshotId|bigint|8|19|0|False|", "KnowHowToAI_Role|RoleId|nvarchar|100|0|0|False|", "KnowHowToAI_Role|Name|nvarchar|200|0|0|False|", "KnowHowToAI_Role|Description|nvarchar|1000|0|0|True|", "KnowHowToAI_Role|IsDeleted|bit|1|1|0|False|DEFAULT",
        "KnowHowToAI_RoleResolution|SnapshotId|bigint|8|19|0|False|", "KnowHowToAI_RoleResolution|RequestedRoleId|nvarchar|100|0|0|False|", "KnowHowToAI_RoleResolution|CandidateRoleId|nvarchar|100|0|0|False|", "KnowHowToAI_RoleResolution|Priority|int|4|10|0|False|",
    ...
    [
        "KnowHowToAI_ContentDependency|CK_KnowHowToAI_ContentDependency_NotSelf", "KnowHowToAI_Node|CK_KnowHowToAI_Node_Parent", "KnowHowToAI_Node|CK_KnowHowToAI_Node_SortOrder", "KnowHowToAI_Node|CK_KnowHowToAI_Node_Title", "KnowHowToAI_NodeContent|CK_KnowHowToAI_NodeContent_Mode", "KnowHowToAI_Release|CK_KnowHowToAI_Release_Name", "KnowHowToAI_Role|CK_KnowHowToAI_Role_Name", "KnowHowToAI_Role|CK_KnowHowToAI_Role_RoleId", "KnowHowToAI_RoleResolution|CK_KnowHowToAI_RoleResolution_Priority", "KnowHowToAI_SchemaMigration|CK_KnowHowToAI_SchemaMigration_Name", "KnowHowToAI_SchemaMigration|CK_KnowHowToAI_SchemaMigration_Version", "KnowHowToAI_Snapshot|CK_KnowHowToAI_Snapshot_Base", "KnowHowToAI_Snapshot|CK_KnowHowToAI_Snapshot_State", "KnowHowToAI_Snapshot|CK_KnowHowToAI_Snapshot_Timestamps", "KnowHowToAI_Snapshot|CK_KnowHowToAI_Snapshot_WorkingBase", "KnowHowToAI_SystemState|CK_KnowHowToAI_SystemState_Singleton", "KnowHowToAI_Transaction|CK_KnowHowToAI_Transaction_ChangeVersion", "KnowHowToAI_Transaction|CK_KnowHowToAI_Transaction_Snapshots", "KnowHowToAI_Transaction|CK_KnowHowToAI_Transaction_State", "KnowHowToAI_Transaction|CK_KnowHowToAI_Transaction_Timestamps"
    ];

    private static readonly string[] ExpectedForeignKeys =
    [
        "KnowHowToAI_ContentDependency|FK_KnowHowToAI_ContentDependency_Source|KnowHowToAI_NodeContent", "KnowHowToAI_ContentDependency|FK_KnowHowToAI_ContentDependency_Target|KnowHowToAI_NodeContent", "KnowHowToAI_Node|FK_KnowHowToAI_Node_Parent|KnowHowToAI_Node", "KnowHowToAI_Node|FK_KnowHowToAI_Node_Snapshot|KnowHowToAI_Snapshot", "KnowHowToAI_NodeContent|FK_KnowHowToAI_NodeContent_Node|KnowHowToAI_Node", "KnowHowToAI_NodeContent|FK_KnowHowToAI_NodeContent_Role|KnowHowToAI_Role", "KnowHowToAI_Release|FK_KnowHowToAI_Release_Snapshot|KnowHowToAI_Snapshot", "KnowHowToAI_Role|FK_KnowHowToAI_Role_Snapshot|KnowHowToAI_Snapshot", "KnowHowToAI_RoleResolution|FK_KnowHowToAI_RoleResolution_CandidateRole|KnowHowToAI_Role", "KnowHowToAI_RoleResolution|FK_KnowHowToAI_RoleResolution_RequestedRole|KnowHowToAI_Role", "KnowHowToAI_RoleResolution|FK_KnowHowToAI_RoleResolution_Snapshot|KnowHowToAI_Snapshot", "KnowHowToAI_Snapshot|FK_KnowHowToAI_Snapshot_BaseSnapshot|KnowHowToAI_Snapshot", "KnowHowToAI_SystemState|FK_KnowHowToAI_SystemState_Snapshot|KnowHowToAI_Snapshot", "KnowHowToAI_Transaction|FK_KnowHowToAI_Transaction_BaseSnapshot|KnowHowToAI_Snapshot", "KnowHowToAI_Transaction|FK_KnowHowToAI_Transaction_WorkingSnapshot|KnowHowToAI_Snapshot"
    ];

    private static readonly string[] ExpectedIndexes =
    [
        "KnowHowToAI_ContentDependency|IX_KnowHowToAI_ContentDependency_Source|SnapshotId ASC,SourceNodeId ASC,SourceRoleId ASC|SourceContentRevisionId,TargetNodeId,TargetRoleId|", "KnowHowToAI_Node|IX_KnowHowToAI_Node_NodeId|NodeId ASC,SnapshotId ASC|ParentNodeId,SortOrder,IsDeleted|", "KnowHowToAI_Node|UQ_KnowHowToAI_Node_ActiveRoot|SnapshotId ASC||([ParentNodeId] IS NULL AND [IsDeleted]=(0))", "KnowHowToAI_Node|UQ_KnowHowToAI_Node_ActiveSiblingSortOrder|SnapshotId ASC,ParentNodeId ASC,SortOrder ASC|NodeId,Title,Description|([ParentNodeId] IS NOT NULL AND [IsDeleted]=(0))", "KnowHowToAI_NodeContent|IX_KnowHowToAI_NodeContent_Revision|ContentRevisionId ASC,SnapshotId ASC|NodeId,RoleId,ContentMode,IsDeleted|", "KnowHowToAI_NodeContent|IX_KnowHowToAI_NodeContent_Role|SnapshotId ASC,RoleId ASC,IsDeleted ASC|NodeId,ContentRevisionId,ContentMode|", "KnowHowToAI_Release|IX_KnowHowToAI_Release_Snapshot|SnapshotId ASC,ReleasedAtUtc ASC|Name|", "KnowHowToAI_Release|UQ_KnowHowToAI_Release_Name|Name ASC||", "KnowHowToAI_Role|IX_KnowHowToAI_Role_RoleId|RoleId ASC,SnapshotId ASC|Name,IsDeleted|", "KnowHowToAI_RoleResolution|IX_KnowHowToAI_RoleResolution_Candidate|SnapshotId ASC,CandidateRoleId ASC|RequestedRoleId,Priority|", "KnowHowToAI_RoleResolution|UQ_KnowHowToAI_RoleResolution_Candidate|SnapshotId ASC,RequestedRoleId ASC,CandidateRoleId ASC||", "KnowHowToAI_SchemaMigration|UQ_KnowHowToAI_SchemaMigration_Name|Name ASC||", "KnowHowToAI_Snapshot|IX_KnowHowToAI_Snapshot_BaseSnapshot|BaseSnapshotId ASC||([BaseSnapshotId] IS NOT NULL)", "KnowHowToAI_Snapshot|IX_KnowHowToAI_Snapshot_State|State ASC,CreatedAtUtc ASC|BaseSnapshotId,CommittedAtUtc|", "KnowHowToAI_Transaction|IX_KnowHowToAI_Transaction_State|State ASC,CreatedAtUtc ASC|BaseSnapshotId,WorkingSnapshotId,ChangeVersion,CommittedAtUtc|", "KnowHowToAI_Transaction|UQ_KnowHowToAI_Transaction_WorkingSnapshot|WorkingSnapshotId ASC||"
    ];
}
