...
public sealed class DomainModelTests
{
    ...
    public void VersionedModels_KeepSnapshotIdentityAndStateWithoutMutation()
    {
        ...
        var audience = new Audience(snapshotId, audienceId, "Developer", "Technische Zielgruppe", false);
        var content = new NodeContent(snapshotId, nodeId, audienceId, revisionId, ContentMode.Derived, "Installiere die Anwendung.", false);
        var dependency = new ContentDependency(snapshotId, nodeId, audienceId, sourceNodeId, audienceId, revisionId);
        ...
        Assert.Equal(audienceId, audience.AudienceId);
