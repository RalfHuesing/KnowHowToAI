...
public sealed class NavigationServiceTests
{
    ...
    private sealed class NavigationTestHarness
    {
        ...
        public void SetCurrentSnapshot(SnapshotId snapshotId)
        {
            ...
            _snapshots.Add(new Snapshot(snapshotId, null, SnapshotState.Committed, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow));
        }
