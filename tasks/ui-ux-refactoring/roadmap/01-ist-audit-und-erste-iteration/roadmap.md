...
- [ ] [M1.5-T1 – Capture 04 Shell/Header-Präsenz deterministisch absichern](tasks/M1.5-T1.md) – Test-only; der Capture darf Produktzustände weder kaschieren noch erzeugen.
