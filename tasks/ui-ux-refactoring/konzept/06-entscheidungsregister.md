...
| UX-003 | Terminologie | „Node“, „Knoten“, „Inhalt“, „Arbeitskopie“ und „Transaction“ tragen unterschiedlich viel technische Last. Das fachliche Adressatenmodell bezeichnet eine Zielgruppe und keine ACL-Zielgruppe. | **Teilweise entschieden.** `Audience/Zielgruppe` wird im eigenen Hard-Cut-Vorhaben technisch zu `Audience` und sichtbar zu „Zielgruppe“ umbenannt; siehe den [Begriffsvertrag](../../audience-hard-cut/roadmap/01-repositoryweiter-audience-hard-cut/planning.md#verbindlicher-begriffsvertrag). Die übrigen Begriffe bleiben Teil des M2-Gates. |
