...
| K-009 | Gesetzt | Rich Text/WYSIWYG mit Markdown als kanonischem Format und Bildern | [Rich-Text-Editor](03-redaktion-und-assets.md#rich-text-editor) |
...
| A-004 | Empfohlen | Offizielle Publikation nur aus committed Snapshot/Release; Working nur Vorschau | [Freigabe](04-publikation-und-pdf.md#freigabe) |
...
| O-005 | Hoch | Editorial-Note-Versionierung | Nicht in `ContentMd`; Snapshotbestandteil oder separat historisierter Workflow |
| O-006 | Mittel | Publikationsprofil-Versionierung | Profil und Assets unveränderlich referenzieren |
| O-007 | Mittel | PDF-Renderer | CSS, TOC, Header/Footer, Fonts, Lizenz und Deployment messen |
| O-008 | Mittel | Presentation Views | Kanonischen Baum behalten; Views auf denselben `NodeId`s später ergänzen |
| O-009 | Niedrig | Integrierte KI | Erst nach stabilen manuellen und redaktionellen Workflows |
