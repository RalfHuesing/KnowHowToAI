...
Abhängigkeit: [M5](05-rollen-content-und-rich-text.md)
...
## M6.1 – Daten- und Anwendungsmodell

- [ ] **M6.1 abschließen**

  - [ ] **M6.1-T1 – Asset-Domain- und Application-Contracts einführen**
  ...
  - [ ] **M6.1-T2 – SQL-Schema und Migration für Assetmetadaten implementieren**
...
## M6.2 – Speicherung und Deduplizierung

- [ ] **M6.2 abschließen**

  - [ ] **M6.2-T1 – Immutable Asset-Speicherung implementieren**
  ...
  - [ ] **M6.2-T2 – Hash-Deduplizierung implementieren**
...
## M6.3 – Upload und Auslieferung

- [ ] **M6.3 abschließen**

  - [ ] **M6.3-T1 – Kontrollierten Browserupload bereitstellen**
  ...
  - [ ] **M6.3-T2 – Kontrollierte Asset-Auslieferung bereitstellen**
...
## M6.4 – Editorintegration

- [ ] **M6.4 abschließen**

  - [ ] **M6.4-T1 – Bild-Upload im Rich-Text-Editor integrieren**
  ...
  - [ ] **M6.4-T2 – Markdown-Bildreferenzen roundtrip-sicher machen**
...
## M6.5 – Lebenszyklus und Adapter

- [ ] **M6.5 abschließen**

  - [ ] **M6.5-T1 – Assetauflösung über alle Ausgabekanäle vereinheitlichen**
    - Umfang: zentraler Resolver für Browser, MCP, Markdown-Export und später PDF; spätere Adapter bleiben anschließbar.
  ...
  - [ ] **M6.5-T2 – Referenzierte, historische und verwaiste Assets behandeln**
...
## M6.6 – Inhalts- und Ressourcengrenzen

- [ ] **M6.6 abschließen**

  - [ ] **M6.6-T1 – Assetgrenzen und Schadinhaltsschutz absichern**
...
- Bilder funktionieren über Upload, Editor, Browser, MCP und Markdown-Export mit stabilen Referenzen.
