...
- [ ] **M5.1 abschließen**
  - [ ] [M5.1-T1 – Rollen- und Content-Writes gegen ChangeVersion absichern](tasks/M5.1-T1.md)
  - [ ] [M5.1-T2 – Zentrale Contentpolicy und MCP-Fehlerverträge vervollständigen](tasks/M5.1-T2.md)
