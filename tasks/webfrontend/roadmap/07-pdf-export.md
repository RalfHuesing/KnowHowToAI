...
Verbindliche M0-Testbasis: Browserfälle verwenden weiterhin Microsoft.Playwright .NET `1.62.0` ausschließlich mit Google Chrome Stable (installierte aktuelle Version), `Channel = "chrome"` und `Headless = true`. Für PDF wird kein zweites Browserframework eingeführt; Rendererwerkzeuge und ihre Versionen werden ausschließlich im M7.0-Gate festgelegt.
