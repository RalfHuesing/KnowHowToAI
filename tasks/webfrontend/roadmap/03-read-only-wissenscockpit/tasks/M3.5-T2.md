...
- [x] **M3.5-T2 – Wissensfilter implementieren**
  - Umfang: Filter für Zielgruppe, Availability, Freshness und Findings auf der paginierten Such-/Filtertrefferliste; Trefferauswahl fokussiert den Node im unveränderten Knowledge Tree.
