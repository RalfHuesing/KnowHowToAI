...
- [x] **M3.9-T4 – Provenienz und Tree-Status aus echten Reads anzeigen**
  ...
  - Tests: geroutete `KnowledgePage` (kein direkt konstruiertes ViewModel) für Current, Snapshot und Working Transaction mit Independent, aktuellem Derived, stale Derived und Fallback auf Derived; Source-ID, Zielgruppe, gespeicherte Revision und Source-Freshness prüfen. Tree-Komponentenfälle prüfen alle Badges und dass Expand weiterhin genau einen 100er-Read auslöst.
