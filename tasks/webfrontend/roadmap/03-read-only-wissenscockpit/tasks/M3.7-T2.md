...
- [x] **M3.7-T2 – Deterministischen Browsernachweis für den Markdown-Download herstellen**
  ...
  - Umfang: Die bestehende Browser-Testinfrastruktur stellt für diesen Test einen reproduzierbaren, nichtleeren Read-only-Wissensstand mit Zielgruppe und auswählbarem Node bereit; der Smoke wartet anschließend auf einen tatsächlichen Download und prüft Status, `text/markdown; charset=utf-8`, `Content-Disposition: attachment`, `Cache-Control: no-store` und den `.md`-Dateinamen.
