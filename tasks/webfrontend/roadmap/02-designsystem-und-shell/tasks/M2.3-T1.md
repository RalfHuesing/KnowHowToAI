...
- [x] **M2.3-T1 – Lade-, Leer- und Fehlerzustände bereitstellen**
  ...
  - Tests: jeder Zustand, Retry genau einmal, fehlende/gesetzte Correlation-ID, kein sensibles Detail, Busy-Doppelaktion blockiert und zugängliche Namen/Zielgruppen.
