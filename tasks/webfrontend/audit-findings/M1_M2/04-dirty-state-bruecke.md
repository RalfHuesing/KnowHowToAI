...
- [x] **AF4.1 abschließen**
  ...
  - [x] **AF4.1-T1 – `data-ktai-dirty`-Attribut etablieren und `beforeunload` darauf umstellen**
    ...
    - Nicht enthalten: `WorkspaceState` aus M3, Zielgruppen-/Transaktionsselektoren, irgendein M3+-Fachfeature, ein Warnungsdialog vor dem Neuladen (der native `beforeunload`-Dialog bleibt das Mittel).
