...
<#
.SYNOPSIS
    Fuehrt FastTests fuer KnowHowTo AI aus und schreibt das Ergebnis statisch nach TestResults/FastTests.trx.
...
$projectPath = Join-Path $repoRoot 'tests/KnowHowToAI.Core.Tests/KnowHowToAI.Core.Tests.csproj'
